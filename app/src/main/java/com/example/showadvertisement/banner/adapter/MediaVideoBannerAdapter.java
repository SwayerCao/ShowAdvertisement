package com.example.showadvertisement.banner.adapter;
...
import com.example.showadvertisement.banner.holder.ImageHolder;
import com.example.showadvertisement.banner.holder.VideoHolder;
...
public class MediaVideoBannerAdapter extends BaseBannerAdapter<ResourceBean, RecyclerView.ViewHolder> {
    ...
    public void updateDataList(List<ResourceBean> mDataS) {
